...
return {
	Weapons = {
		...
		['WEAPON_STRICKLER'] = { --Midnight Added from GTAV Update
			label = 'The Strickler',
			weight = 300,
			durability = 0.03,
			ammotype = 'ammo-rifle',
		...
		['WEAPON_SWITCHBLADE'] = {
			...
			weight = 300,
			durability = 0.1,
			anim = 'anim@melee@switchblade@holster',
		},
		...
		['WEAPON_BASEBALL_BATS'] = {
			label = 'BatS',
			weight = 2500,
			durability = 0.1,
		},
		['WEAPON_BLUEBFKNIFE'] = {
			label = 'Blue BFKNIFE Knife',
			weight = 2500,
			durability = 0.1,
		},
		['WEAPON_CASEHARDENEDBFKNIFE'] = {
			label = 'Case Hardened BFKNIFE',
			weight = 2500,
			durability = 0.1,
		},
		['WEAPON_CRIMSONBFKNIFE'] = {
			label = 'Crimson BFKNIFE',
			weight = 2500,
			durability = 0.1,
		},
		['WEAPON_FADEDBFKNIFE'] = {
		...
		['WEAPON_SAFARIMESHBFKNIFE'] = {
			label = 'Safarimesh BFKNIFE',
			weight = 2500,
			durability = 0.1,
		},
		['WEAPON_SCORCHEDBFKNIFE'] = {
			label = 'Scorched BFKNIFE',
			weight = 2500,
			durability = 0.1,
		},
		['WEAPON_SLAUGHTERBFKNIFE'] = {
			label = 'Slaughter BFKNIFE',
			weight = 2500,
			durability = 0.1,
		},
		['WEAPON_STAINEDBFKNIFE'] = {
			label = 'Stained BFKNIFE',
			weight = 2500,
			durability = 0.1,
		},
		['WEAPON_URBANMASKEDBFKNIFE'] = {
			label = 'Urban Masked BFKNIFE',
			weight = 2500,
			durability = 0.1,
		},
		['WEAPON_VANILLABFKNIFE'] = {
			label = 'Vanilla BFKNIFE',
			weight = 2500,
			durability = 0.1,
		},
		-- custom guns
		...
		['at_grip'] = {
			...
			client = {
				component = {
					...
					`COMPONENT_M6IC_STOCK_02`,
					`COMPONENT_M6IC_STOCK_03`,
					`COMPONENT_M6IC_STOCK_04`,
					`COMPONENT_M6IC_STOCK_05`,
					`COMPONENT_M6IC_STOCK_06`,
					`COMPONENT_M6IC_STOCK_07`,
		...
		['at_clip_extended_rifle'] = {
			...
			client = {
				...
				component = {
					...
					`COMPONENT_M6IC_CLIP_02`,
					`COMPONENT_M6IC_CLIP_03`,
					`COMPONENT_M6IC_CLIP_04`,
					`COMPONENT_M6IC_CLIP_05`,
		...
		['at_scope_large'] = {
			...
			client = {
				component = {
					...
					`COMPONENT_AT_SCOPE_LARGE_MK2`,
					`COMPONENT_M6IC_SCOPE_03`,
					`COMPONENT_M6IC_SCOPE_04`,
					`COMPONENT_M6IC_SCOPE_05`,
					`COMPONENT_M6IC_SCOPE_06`,
					`COMPONENT_M6IC_SCOPE_07`,
					`COMPONENT_M6IC_SCOPE_08`,
					`COMPONENT_M6IC_SCOPE_09`,
					`COMPONENT_M6IC_SCOPE_10`,
